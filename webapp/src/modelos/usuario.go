...
func BuscarUsuarioCompleto(usuarioID uint64, r *http.Request) (Usuario, error) {
	...
	for i := 0; i < 4; i++ {
		...
		case publicacoesCaregadas := <-canalPublicacoes:
			if publicacoesCaregadas == nil {
				return Usuario{}, errors.New("erro ao buscar as publicações")
			}

			publicacoes = publicacoesCaregadas
		}
	}
...
// BuscarSeguindo chama a API para buscar os usuários seguidos por outro
