...
func CaregarTelaDeLogin(w http.ResponseWriter, r *http.Request) {
...
// CarregarPerfilDoUsuario carrega a pagina do perfil do usuário
...
// CarregarPerfilDoUsuarioLogado carrega a pagina do perfil do usuário logado
...
// CarregarPerfilDoUsuarioLogado carrega a pagina para edição dos dados do usuário
